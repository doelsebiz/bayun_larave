     ...
     <div class="bg-color">
         ...
         <nav class="navbar navbar-default animated fadedown">
           ...
           <span class="icon-bar"></span>
                         ...
                         <a style=" width: 200px; " class="navbar-brand" href="#home-section"><img class="img-responsive" src="<?php echo e(url('public/assets/images/logo.png')); ?>"></a>
                     </div>
                         ...
                         <div class="row">
                             ...
                             <!-- <div class="col-md-4 col-sm-5 col-xs-12 pull-right animated faderight">
                                 <div id="owl-trans-iphone" class="iphone-bg owl-carousel owl-theme">
                                     <div class="item">
                                         <img class="img-responsive centered" src="<?php echo e(url('public/assets/images/iphone-slider/1.jpg')); ?>" alt="">
                                     </div>
                                     <div class="item">
                                         <img class="img-responsive centered" src="<?php echo e(url('public/assets/images/iphone-slider/2.jpg')); ?>" alt="">
                                     </div>
                                     <div class="item">
                                         <img class="img-responsive centered" src="<?php echo e(url('public/assets/images/iphone-slider/3.jpg')); ?>" alt="">
                                     </div>
                                     <div class="item">
                                         <img class="img-responsive centered" src="<?php echo e(url('public/assets/images/iphone-slider/4.jpg')); ?>" alt="">
                                     </div>
                                     <div class="item">
                                         <img class="img-responsive centered" src="<?php echo e(url('public/assets/images/iphone-slider/5.jpg')); ?>" alt="">
                                     </div>
                                     <div class="item">
                                         <img class="img-responsive centered" src="<?php echo e(url('public/assets/images/iphone-slider/6.jpg')); ?>" alt="">
                                     </div>
                                     <div class="item">
                                         <img class="img-responsive centered" src="<?php echo e(url('public/assets/images/iphone-slider/7.jpg')); ?>" alt="">
                                     </div>
                                     <div class="item">
                                         <img class="img-responsive centered" src="<?php echo e(url('public/assets/images/iphone-slider/8.jpg')); ?>" alt="">
                                     </div>
                                 </div>
                             </div> -->
                         </div>
         ...
         <div class="row">
             ...
             <div class="col-md-7 col-sm-12 col-xs-12 pull-right">
                 <div class="why-img animated faderight">
                     <img class="img-responsive pull-right centered" src="<?php echo e(url('public/assets/images/why.png')); ?>" alt="">
                 </div>
             </div>
         </div>
     </div>
             ...
             <div class="row">
                 <div class="col-md-12 col-sm-12 col-xs-12">
                     ...
                     <div class="contactDiv centered animated fadeup">
                         ...
                         <form class="form-inline" action="<?php echo e(url('sendquote')); ?>" method="post"  novalidate="novalidate">
                           <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamp\htdocs\bayun_laravel\resources\views/frontend/homepage/index.blade.php ENDPATH**/ ?>